            ...
            try
            {
                ...
                for (int i = 0; i < ds.Tables[1].Rows.Count; i++)
                {
                    ...
                    for (int j = 0; j < ds.Tables[2].Rows.Count; j++)
                    {
                        ...
                        route.startingPointId = (ds.Tables[2].Rows[j]["startingPointId"] == DBNull.Value ? 0 : (int)ds.Tables[2].Rows[j]["startingPointId"]);
                        route.startingPointlatitude = (ds.Tables[2].Rows[j]["startingPointlatitude"] == DBNull.Value ? "" : ds.Tables[2].Rows[j]["startingPointlatitude"].ToString());
                        route.startingPointlongitude = (ds.Tables[2].Rows[j]["startingPointlongitude"] == DBNull.Value ? "" : ds.Tables[2].Rows[j]["startingPointlongitude"].ToString());
                        route.startingPointcountry = (ds.Tables[2].Rows[j]["startingPointcountry"] == DBNull.Value ? "" : ds.Tables[2].Rows[j]["startingPointcountry"].ToString());
                        route.startingPointstate = (ds.Tables[2].Rows[j]["startingPointstate"] == DBNull.Value ? "" : ds.Tables[2].Rows[j]["startingPointstate"].ToString());
                        route.startingPointcityName = (ds.Tables[2].Rows[j]["startingPointcityName"] == DBNull.Value ? "" : ds.Tables[2].Rows[j]["startingPointcityName"].ToString());
                        route.startingPointaddress = (ds.Tables[2].Rows[j]["startingPointaddress"] == DBNull.Value ? "" : ds.Tables[2].Rows[j]["startingPointaddress"].ToString());
                        route.endPointId = (ds.Tables[2].Rows[j]["endPointId"] == DBNull.Value ? 0 : (int)ds.Tables[2].Rows[j]["endPointId"]);
                        route.endPointlatitude = (ds.Tables[2].Rows[j]["endPointlatitude"] == DBNull.Value ? "" : ds.Tables[2].Rows[j]["endPointlatitude"].ToString());
                        route.endPointlongitude = (ds.Tables[2].Rows[j]["endPointlongitude"] == DBNull.Value ? "" : ds.Tables[2].Rows[j]["endPointlongitude"].ToString());
                        route.endPointcountry = (ds.Tables[2].Rows[j]["endPointcountry"] == DBNull.Value ? "" : ds.Tables[2].Rows[j]["endPointcountry"].ToString());
                        route.endPointstate = (ds.Tables[2].Rows[j]["endPointstate"] == DBNull.Value ? "" : ds.Tables[2].Rows[j]["endPointstate"].ToString());
                        route.endPointcityName = (ds.Tables[2].Rows[j]["endPointcityName"] == DBNull.Value ? "" : ds.Tables[2].Rows[j]["endPointcityName"].ToString());
                        route.endPointaddress = (ds.Tables[2].Rows[j]["endPointaddress"] == DBNull.Value ? "" : ds.Tables[2].Rows[j]["endPointaddress"].ToString());
